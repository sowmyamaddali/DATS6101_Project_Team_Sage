...
• FP – False Positive : A false positive is an outcome where the model incorrectly predicts the positive class, here Patient who does not have stroke is classified as a patient having a stroke.

• FN – False Negative : A false negative is an outcome where the model incorrectly predicts the negative class, here Patient who has a stroke but is classified as no stroke.
