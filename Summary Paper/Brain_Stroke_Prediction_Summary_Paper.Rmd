...
- Work_type and smoking_ habit(which includes non-smokers too) of a person can lead to a stroke.
- Age has played a major role for someone to get affected by stroke.
- Age with factors like a persons Body Mass Index, Average glucose level, hypertension, and if he/she has any sort of heart disease   plays an important role in predicting if that person can suffer from a stroke.
