...
Dataset is available at : [Kaggle](https://www.kaggle.com/datasets/fedesoriano/stroke-prediction-dataset)

Stroke Disease Detection and Prediction Using Robust Learning Approaches. Tahia Tazin, Md Nur Alam, 1 Nahian Nakiba Dola, Mohammad Sajibul Bari, Sami Bourouis, and Mohammad Monirujjaman Khan. Retrieved from (https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8641997/)

A predictive analytics approach for stroke prediction using machine learning and neural networks. Soumyabrata Devab, Hewei Wangcd Chidozie, Shamrock Nwosue, Nishtha Jain, Bharadwaj Veeravallif, Deepu John (https://www.sciencedirect.com/science/article/pii/S2772442522000090)
