...
```{r}
ggplot(data = stroke_df, aes(x=as.character(hypertension), y=age)) +
...
```{r}
# not needed
ggplot(data = stroke_df, aes(x=as.character(hypertension), y=avg_glucose_level)) +
    geom_boxplot(fill="steelblue") +
    labs(title="Average Glucose Level distribution by hypertension", x="hypertension", y="avg_glucose_level")
```

```{r}
ggplot(data = stroke_df, aes(x=as.character(heart_disease ), y=age)) +
    geom_boxplot(fill="steelblue") +
    labs(title="Age distribution by heart_disease ", x="heart_disease ", y="age")
```

Heart disease is related to age

```{r}
# not needed
ggplot(data = stroke_df, aes(x=as.character(heart_disease ), y=avg_glucose_level)) +
    geom_boxplot(fill="steelblue") +
